...
`endif
  ...
  // expansion 2 source clock
  input clk_src_exp2_en_i,                     // EXP2 Source Clock Enable
  input prim_mubi_pkg::mubi4_t clk_src_exp2_jen_i,  // EXP2 Source Clock Jitter Enable
  output logic clk_src_exp2_o,                 // EXP2 Source Clock
  output logic clk_src_exp2_val_o,             // EXP2 Source Clock Valid
...
///////////////////////////////////////
// Expansion 2 Clock (Always ON)
///////////////////////////////////////
logic rst_exp2_clk_n, clk_exp2_pd_n;
logic clk_exp2_en, clk_osc_exp2, clk_osc_exp2_val;
prim_mubi_pkg::mubi4_t clk_src_exp2_jen;

assign rst_exp2_clk_n = vcmain_pok_por && vcc_pok;
assign clk_exp2_pd_n  = scan_mode || !deep_sleep;

logic exp2_osc_cal;

assign clk_exp2_en = clk_src_exp2_en_i;

`ifdef AST_BYPASS_CLK
logic clk_exp2_ext;
assign clk_exp2_ext = clk_osc_byp_i.exp2;
`endif

exp2_clk u_exp2_clk (
  .clk_src_exp2_jen_i ( prim_mubi_pkg::mubi4_test_true_loose(clk_src_exp2_jen) ),
  .clk_src_exp2_en_i ( clk_exp2_en ),
  .clk_exp2_pd_ni ( clk_exp2_pd_n ),
  .rst_exp2_clk_ni ( rst_exp2_clk_n ),
  .vcore_pok_h_i ( vcaon_pok_h ),
  .scan_mode_i ( scan_mode ),
  .exp2_osc_cal_i ( exp2_osc_cal ),
`ifdef AST_BYPASS_CLK
  .clk_exp2_ext_i ( clk_exp2_ext ),
`endif
  .clk_src_exp2_o ( clk_osc_exp2 ),
  .clk_src_exp2_val_o ( clk_osc_exp2_val )
);
...
// Expansion 2 source clock buffer
////////////////////////////////////////
prim_clock_buf #(
  .NoFpgaBuf ( 1'b1 )
) u_clk_src_exp2_buf (
...
assign clk_src_exp2_val_o = clk_osc_exp2_val;
