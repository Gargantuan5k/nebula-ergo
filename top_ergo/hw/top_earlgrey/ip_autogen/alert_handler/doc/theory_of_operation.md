...
---------------|-----------------------|----------------|---------------
`NAlerts`      | 8 (248)               | 45    | Number of alert instances. Maximum number bounded by LFSR implementation that generates ping timing.
`NLpg`         | 1                     | 15       | Number of unique low-power groups as determined by topgen.
