...
package rstmgr_pkg;
  ...
  typedef struct packed {
    ...
    logic [PowerDomains-1:0] rst_por_exp_n;
    logic [PowerDomains-1:0] rst_por_main_div2_n;
    logic [PowerDomains-1:0] rst_por_main_div10_n;
    logic [PowerDomains-1:0] rst_por_usb_div4_n;
    logic [PowerDomains-1:0] rst_por_exp_div2_n;
    logic [PowerDomains-1:0] rst_por_exp_div8_n;
    logic [PowerDomains-1:0] rst_por_exp2_n;
    logic [PowerDomains-1:0] rst_por_exp2_div2_n;
    logic [PowerDomains-1:0] rst_por_exp2_div6_n;
    ...
    logic [PowerDomains-1:0] rst_lc_exp_n;
    logic [PowerDomains-1:0] rst_lc_main_div2_n;
    logic [PowerDomains-1:0] rst_lc_main_div10_n;
    logic [PowerDomains-1:0] rst_lc_usb_div4_n;
    logic [PowerDomains-1:0] rst_lc_exp_div2_n;
    logic [PowerDomains-1:0] rst_lc_exp_div8_n;
    logic [PowerDomains-1:0] rst_lc_exp2_n;
    logic [PowerDomains-1:0] rst_lc_exp2_div2_n;
    logic [PowerDomains-1:0] rst_lc_exp2_div6_n;
  ...
  typedef struct packed {
    ...
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] por_exp;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] por_main_div2;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] por_main_div10;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] por_usb_div4;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] por_exp_div2;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] por_exp_div8;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] por_exp2;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] por_exp2_div2;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] por_exp2_div6;
    ...
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] lc_exp;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] lc_main_div2;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] lc_main_div10;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] lc_usb_div4;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] lc_exp_div2;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] lc_exp_div8;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] lc_exp2;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] lc_exp2_div2;
    prim_mubi_pkg::mubi4_t [PowerDomains-1:0] lc_exp2_div6;
