...
#(
  ...
  input clk_usb_i,
  input clk_exp_i,
  input clk_main_div2_i,
  input clk_main_div10_i,
  input clk_usb_div4_i,
  input clk_exp_div2_i,
  input clk_exp_div8_i,
  input clk_exp2_i,
  input clk_exp2_div2_i,
  input clk_exp2_div6_i,
  input clk_por_i,
  input rst_por_ni,
  ...
  rstmgr_leaf_rst #(
    ...
    .clk_i,
    .rst_ni,
    .leaf_clk_i(clk_exp_i),
    .parent_rst_ni(rst_por_aon_n[DomainAonSel]),
    .sw_rst_req_ni(1'b1),
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_exp[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_por_exp_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[5][DomainAonSel]),
    .fsm_err_o(fsm_errs[5][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_por_exp_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonPorExpFsmCheck_A,
    u_daon_por_exp.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign resets_o.rst_por_exp_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[5][Domain0Sel] = '0;
  assign fsm_errs[5][Domain0Sel] = '0;
  assign rst_en_o.por_exp[Domain0Sel] = MuBi4True;
  assign shadow_cnsty_chk_errs[5] = '0;
  assign shadow_fsm_errs[5] = '0;

  // Generating resets for por_main_div2
  // Power Domains: ['Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    .SecMaxSyncDelay(SecMaxSyncDelay),
    .SwRstReq(1'b0)
  ) u_daon_por_main_div2 (
    .clk_i,
    .rst_ni,
    .leaf_clk_i(clk_main_div2_i),
    .parent_rst_ni(rst_por_aon_n[DomainAonSel]),
    .sw_rst_req_ni(1'b1),
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_main_div2[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_por_main_div2_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[6][DomainAonSel]),
    .fsm_err_o(fsm_errs[6][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_por_main_div2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonPorMainDiv2FsmCheck_A,
    u_daon_por_main_div2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign resets_o.rst_por_main_div2_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[6][Domain0Sel] = '0;
  assign fsm_errs[6][Domain0Sel] = '0;
  assign rst_en_o.por_main_div2[Domain0Sel] = MuBi4True;
  assign shadow_cnsty_chk_errs[6] = '0;
  assign shadow_fsm_errs[6] = '0;

  // Generating resets for por_main_div10
  // Power Domains: ['Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    .SecMaxSyncDelay(SecMaxSyncDelay),
    .SwRstReq(1'b0)
  ) u_daon_por_main_div10 (
    .clk_i,
    .rst_ni,
    .leaf_clk_i(clk_main_div10_i),
    .parent_rst_ni(rst_por_aon_n[DomainAonSel]),
    .sw_rst_req_ni(1'b1),
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_main_div10[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_por_main_div10_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[7][DomainAonSel]),
    .fsm_err_o(fsm_errs[7][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_por_main_div10_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonPorMainDiv10FsmCheck_A,
    u_daon_por_main_div10.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign resets_o.rst_por_main_div10_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[7][Domain0Sel] = '0;
  assign fsm_errs[7][Domain0Sel] = '0;
  assign rst_en_o.por_main_div10[Domain0Sel] = MuBi4True;
  assign shadow_cnsty_chk_errs[7] = '0;
  assign shadow_fsm_errs[7] = '0;

  // Generating resets for por_usb_div4
  // Power Domains: ['Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .clk_i,
    .rst_ni,
    .leaf_clk_i(clk_usb_div4_i),
    .parent_rst_ni(rst_por_aon_n[DomainAonSel]),
    .sw_rst_req_ni(1'b1),
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_usb_div4[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_por_usb_div4_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[8][DomainAonSel]),
    .fsm_err_o(fsm_errs[8][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_por_usb_div4_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonPorUsbDiv4FsmCheck_A,
    u_daon_por_usb_div4.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign resets_o.rst_por_usb_div4_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[8][Domain0Sel] = '0;
  assign fsm_errs[8][Domain0Sel] = '0;
  assign rst_en_o.por_usb_div4[Domain0Sel] = MuBi4True;
  assign shadow_cnsty_chk_errs[8] = '0;
  assign shadow_fsm_errs[8] = '0;

  // Generating resets for por_exp_div2
  // Power Domains: ['Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .clk_i,
    .rst_ni,
    .leaf_clk_i(clk_exp_div2_i),
    .parent_rst_ni(rst_por_aon_n[DomainAonSel]),
    .sw_rst_req_ni(1'b1),
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_exp_div2[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_por_exp_div2_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[9][DomainAonSel]),
    .fsm_err_o(fsm_errs[9][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_por_exp_div2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonPorExpDiv2FsmCheck_A,
    u_daon_por_exp_div2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign resets_o.rst_por_exp_div2_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[9][Domain0Sel] = '0;
  assign fsm_errs[9][Domain0Sel] = '0;
  assign rst_en_o.por_exp_div2[Domain0Sel] = MuBi4True;
  assign shadow_cnsty_chk_errs[9] = '0;
  assign shadow_fsm_errs[9] = '0;

  // Generating resets for por_exp_div8
  // Power Domains: ['Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .clk_i,
    .rst_ni,
    .leaf_clk_i(clk_exp_div8_i),
    .parent_rst_ni(rst_por_aon_n[DomainAonSel]),
    .sw_rst_req_ni(1'b1),
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_exp_div8[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_por_exp_div8_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[10][DomainAonSel]),
    .fsm_err_o(fsm_errs[10][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_por_exp_div8_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonPorExpDiv8FsmCheck_A,
    u_daon_por_exp_div8.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign resets_o.rst_por_exp_div8_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[10][Domain0Sel] = '0;
  assign fsm_errs[10][Domain0Sel] = '0;
  assign rst_en_o.por_exp_div8[Domain0Sel] = MuBi4True;
  assign shadow_cnsty_chk_errs[10] = '0;
  assign shadow_fsm_errs[10] = '0;

  // Generating resets for por_exp2
  // Power Domains: ['Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .clk_i,
    .rst_ni,
    .leaf_clk_i(clk_exp2_i),
    .parent_rst_ni(rst_por_aon_n[DomainAonSel]),
    .sw_rst_req_ni(1'b1),
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_exp2[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_por_exp2_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[11][DomainAonSel]),
    .fsm_err_o(fsm_errs[11][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_por_exp2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonPorExp2FsmCheck_A,
    u_daon_por_exp2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign resets_o.rst_por_exp2_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[11][Domain0Sel] = '0;
  assign fsm_errs[11][Domain0Sel] = '0;
  assign rst_en_o.por_exp2[Domain0Sel] = MuBi4True;
  assign shadow_cnsty_chk_errs[11] = '0;
  assign shadow_fsm_errs[11] = '0;

  // Generating resets for por_exp2_div2
  // Power Domains: ['Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    .SecMaxSyncDelay(SecMaxSyncDelay),
    .SwRstReq(1'b0)
  ) u_daon_por_exp2_div2 (
    .clk_i,
    .rst_ni,
    .leaf_clk_i(clk_exp2_div2_i),
    .parent_rst_ni(rst_por_aon_n[DomainAonSel]),
    .sw_rst_req_ni(1'b1),
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_exp2_div2[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_por_exp2_div2_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[12][DomainAonSel]),
    .fsm_err_o(fsm_errs[12][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_por_exp2_div2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonPorExp2Div2FsmCheck_A,
    u_daon_por_exp2_div2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign resets_o.rst_por_exp2_div2_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[12][Domain0Sel] = '0;
  assign fsm_errs[12][Domain0Sel] = '0;
  assign rst_en_o.por_exp2_div2[Domain0Sel] = MuBi4True;
  assign shadow_cnsty_chk_errs[12] = '0;
  assign shadow_fsm_errs[12] = '0;

  // Generating resets for por_exp2_div6
  // Power Domains: ['Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    .SecMaxSyncDelay(SecMaxSyncDelay),
    .SwRstReq(1'b0)
  ) u_daon_por_exp2_div6 (
    .clk_i,
    .rst_ni,
    .leaf_clk_i(clk_exp2_div6_i),
    .parent_rst_ni(rst_por_aon_n[DomainAonSel]),
    .sw_rst_req_ni(1'b1),
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_exp2_div6[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_por_exp2_div6_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[13][DomainAonSel]),
    .fsm_err_o(fsm_errs[13][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_por_exp2_div6_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonPorExp2Div6FsmCheck_A,
    u_daon_por_exp2_div6.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign resets_o.rst_por_exp2_div6_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[13][Domain0Sel] = '0;
  assign fsm_errs[13][Domain0Sel] = '0;
  assign rst_en_o.por_exp2_div6[Domain0Sel] = MuBi4True;
  ...
  rstmgr_leaf_rst #(
    ...
    .err_o(shadow_cnsty_chk_errs[14][DomainAonSel]),
    .fsm_err_o(shadow_fsm_errs[14][DomainAonSel])
  );
  ...
  rstmgr_leaf_rst #(
    ...
    .err_o(shadow_cnsty_chk_errs[14][Domain0Sel]),
    .fsm_err_o(shadow_fsm_errs[14][Domain0Sel])
  );
  ...
  rstmgr_leaf_rst #(
    ...
    .err_o(shadow_cnsty_chk_errs[18][DomainAonSel]),
    .fsm_err_o(shadow_fsm_errs[18][DomainAonSel])
  );
  ...
  rstmgr_leaf_rst #(
    ...
    .err_o(shadow_cnsty_chk_errs[18][Domain0Sel]),
    .fsm_err_o(shadow_fsm_errs[18][Domain0Sel])
  );
  ...
  rstmgr_leaf_rst #(
    ...
    .err_o(cnsty_chk_errs[19][DomainAonSel]),
    .fsm_err_o(fsm_errs[19][DomainAonSel])
  );
  ...
  rstmgr_leaf_rst #(
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_lc_exp_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[20][DomainAonSel]),
    .fsm_err_o(fsm_errs[20][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_lc_exp_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonLcExpFsmCheck_A,
    u_daon_lc_exp.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_lc_exp_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[20][Domain0Sel]),
    .fsm_err_o(fsm_errs[20][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_lc_exp_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0LcExpFsmCheck_A,
    u_d0_lc_exp.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign shadow_cnsty_chk_errs[20] = '0;
  assign shadow_fsm_errs[20] = '0;

  // Generating resets for lc_main_div2
  // Power Domains: ['0', 'Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_main_div2[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_lc_main_div2_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[21][DomainAonSel]),
    .fsm_err_o(fsm_errs[21][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_lc_main_div2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonLcMainDiv2FsmCheck_A,
    u_daon_lc_main_div2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_main_div2[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_lc_main_div2_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[21][Domain0Sel]),
    .fsm_err_o(fsm_errs[21][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_lc_main_div2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0LcMainDiv2FsmCheck_A,
    u_d0_lc_main_div2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign shadow_cnsty_chk_errs[21] = '0;
  assign shadow_fsm_errs[21] = '0;

  // Generating resets for lc_main_div10
  // Power Domains: ['0', 'Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_main_div10[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_lc_main_div10_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[22][DomainAonSel]),
    .fsm_err_o(fsm_errs[22][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_lc_main_div10_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonLcMainDiv10FsmCheck_A,
    u_daon_lc_main_div10.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_main_div10[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_lc_main_div10_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[22][Domain0Sel]),
    .fsm_err_o(fsm_errs[22][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_lc_main_div10_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0LcMainDiv10FsmCheck_A,
    u_d0_lc_main_div10.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign shadow_cnsty_chk_errs[22] = '0;
  assign shadow_fsm_errs[22] = '0;

  // Generating resets for lc_usb_div4
  // Power Domains: ['0', 'Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_usb_div4[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_lc_usb_div4_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[23][DomainAonSel]),
    .fsm_err_o(fsm_errs[23][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_lc_usb_div4_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonLcUsbDiv4FsmCheck_A,
    u_daon_lc_usb_div4.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_usb_div4[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_lc_usb_div4_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[23][Domain0Sel]),
    .fsm_err_o(fsm_errs[23][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_lc_usb_div4_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0LcUsbDiv4FsmCheck_A,
    u_d0_lc_usb_div4.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign shadow_cnsty_chk_errs[23] = '0;
  assign shadow_fsm_errs[23] = '0;

  // Generating resets for lc_exp_div2
  // Power Domains: ['0', 'Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp_div2[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_lc_exp_div2_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[24][DomainAonSel]),
    .fsm_err_o(fsm_errs[24][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_lc_exp_div2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonLcExpDiv2FsmCheck_A,
    u_daon_lc_exp_div2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp_div2[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_lc_exp_div2_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[24][Domain0Sel]),
    .fsm_err_o(fsm_errs[24][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_lc_exp_div2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0LcExpDiv2FsmCheck_A,
    u_d0_lc_exp_div2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign shadow_cnsty_chk_errs[24] = '0;
  assign shadow_fsm_errs[24] = '0;

  // Generating resets for lc_exp_div8
  // Power Domains: ['0', 'Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp_div8[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_lc_exp_div8_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[25][DomainAonSel]),
    .fsm_err_o(fsm_errs[25][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_lc_exp_div8_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonLcExpDiv8FsmCheck_A,
    u_daon_lc_exp_div8.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp_div8[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_lc_exp_div8_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[25][Domain0Sel]),
    .fsm_err_o(fsm_errs[25][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_lc_exp_div8_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0LcExpDiv8FsmCheck_A,
    u_d0_lc_exp_div8.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign shadow_cnsty_chk_errs[25] = '0;
  assign shadow_fsm_errs[25] = '0;

  // Generating resets for lc_exp2
  // Power Domains: ['0', 'Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp2[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_lc_exp2_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[26][DomainAonSel]),
    .fsm_err_o(fsm_errs[26][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_lc_exp2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonLcExp2FsmCheck_A,
    u_daon_lc_exp2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp2[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_lc_exp2_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[26][Domain0Sel]),
    .fsm_err_o(fsm_errs[26][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_lc_exp2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0LcExp2FsmCheck_A,
    u_d0_lc_exp2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign shadow_cnsty_chk_errs[26] = '0;
  assign shadow_fsm_errs[26] = '0;

  // Generating resets for lc_exp2_div2
  // Power Domains: ['0', 'Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp2_div2[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_lc_exp2_div2_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[27][DomainAonSel]),
    .fsm_err_o(fsm_errs[27][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_lc_exp2_div2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonLcExp2Div2FsmCheck_A,
    u_daon_lc_exp2_div2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp2_div2[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_lc_exp2_div2_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[27][Domain0Sel]),
    .fsm_err_o(fsm_errs[27][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_lc_exp2_div2_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0LcExp2Div2FsmCheck_A,
    u_d0_lc_exp2_div2.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  assign shadow_cnsty_chk_errs[27] = '0;
  assign shadow_fsm_errs[27] = '0;

  // Generating resets for lc_exp2_div6
  // Power Domains: ['0', 'Aon']
  // Shadowed: False
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp2_div6[DomainAonSel]),
    .leaf_rst_o(resets_o.rst_lc_exp2_div6_n[DomainAonSel]),
    .err_o(cnsty_chk_errs[28][DomainAonSel]),
    .fsm_err_o(fsm_errs[28][DomainAonSel])
  );

  if (SecCheck) begin : gen_daon_lc_exp2_div6_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    DAonLcExp2Div6FsmCheck_A,
    u_daon_lc_exp2_div6.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  rstmgr_leaf_rst #(
    .SecCheck(SecCheck),
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.lc_exp2_div6[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_lc_exp2_div6_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[28][Domain0Sel]),
    .fsm_err_o(fsm_errs[28][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_lc_exp2_div6_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0LcExp2Div6FsmCheck_A,
    u_d0_lc_exp2_div6.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
  ...
  rstmgr_leaf_rst #(
    ...
    .err_o(cnsty_chk_errs[30][DomainAonSel]),
    .fsm_err_o(fsm_errs[30][DomainAonSel])
  );
  ...
  assign cnsty_chk_errs[30][Domain0Sel] = '0;
  assign fsm_errs[30][Domain0Sel] = '0;
