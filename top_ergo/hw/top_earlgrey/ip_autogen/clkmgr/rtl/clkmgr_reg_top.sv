...
module clkmgr_reg_top (
  ...
  logic clk_enables_clk_exp_peri_en_qs;
  logic clk_enables_clk_exp_peri_en_wd;
  logic clk_enables_clk_exp_div2_peri_en_qs;
  logic clk_enables_clk_exp_div2_peri_en_wd;
  logic clk_enables_clk_exp_div8_peri_en_qs;
  logic clk_enables_clk_exp_div8_peri_en_wd;
  logic clk_enables_clk_main_div2_peri_en_qs;
  logic clk_enables_clk_main_div2_peri_en_wd;
  logic clk_enables_clk_main_div10_peri_en_qs;
  logic clk_enables_clk_main_div10_peri_en_wd;
  logic clk_enables_clk_usb_div4_peri_en_qs;
  logic clk_enables_clk_usb_div4_peri_en_wd;
  ...
  logic clk_enables_clk_exp2_peri_en_qs;
  logic clk_enables_clk_exp2_peri_en_wd;
  logic clk_enables_clk_exp2_div2_peri_en_qs;
  logic clk_enables_clk_exp2_div2_peri_en_wd;
  logic clk_enables_clk_exp2_div6_peri_en_qs;
  logic clk_enables_clk_exp2_div6_peri_en_wd;
  ...
  //   F[clk_exp_peri_en]: 2:2
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_clk_enables_clk_exp_peri_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (clk_enables_we),
    .wd     (clk_enables_clk_exp_peri_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_enables.clk_exp_peri_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (clk_enables_clk_exp_peri_en_qs)
  );

  //   F[clk_exp_div2_peri_en]: 3:3
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_clk_enables_clk_exp_div2_peri_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (clk_enables_we),
    .wd     (clk_enables_clk_exp_div2_peri_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_enables.clk_exp_div2_peri_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (clk_enables_clk_exp_div2_peri_en_qs)
  );

  //   F[clk_exp_div8_peri_en]: 4:4
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_clk_enables_clk_exp_div8_peri_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (clk_enables_we),
    .wd     (clk_enables_clk_exp_div8_peri_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_enables.clk_exp_div8_peri_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (clk_enables_clk_exp_div8_peri_en_qs)
  );

  //   F[clk_main_div2_peri_en]: 5:5
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_clk_enables_clk_main_div2_peri_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (clk_enables_we),
    .wd     (clk_enables_clk_main_div2_peri_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_enables.clk_main_div2_peri_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (clk_enables_clk_main_div2_peri_en_qs)
  );

  //   F[clk_main_div10_peri_en]: 6:6
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_clk_enables_clk_main_div10_peri_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (clk_enables_we),
    .wd     (clk_enables_clk_main_div10_peri_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_enables.clk_main_div10_peri_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (clk_enables_clk_main_div10_peri_en_qs)
  );

  //   F[clk_usb_div4_peri_en]: 7:7
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_clk_enables_clk_usb_div4_peri_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (clk_enables_we),
    .wd     (clk_enables_clk_usb_div4_peri_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_enables.clk_usb_div4_peri_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (clk_enables_clk_usb_div4_peri_en_qs)
  );

  //   F[clk_main_peri_en]: 8:8
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
  ...
  //   F[clk_exp2_peri_en]: 10:10
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_clk_enables_clk_exp2_peri_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (clk_enables_we),
    .wd     (clk_enables_clk_exp2_peri_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_enables.clk_exp2_peri_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (clk_enables_clk_exp2_peri_en_qs)
  );

  //   F[clk_exp2_div2_peri_en]: 11:11
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_clk_enables_clk_exp2_div2_peri_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (clk_enables_we),
    .wd     (clk_enables_clk_exp2_div2_peri_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_enables.clk_exp2_div2_peri_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (clk_enables_clk_exp2_div2_peri_en_qs)
  );

  //   F[clk_exp2_div6_peri_en]: 12:12
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_clk_enables_clk_exp2_div6_peri_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (clk_enables_we),
    .wd     (clk_enables_clk_exp2_div6_peri_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_enables.clk_exp2_div6_peri_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (clk_enables_clk_exp2_div6_peri_en_qs)
  );

  //   F[clk_io_peri_en]: 13:13
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h1),
  ...
  always_comb begin
    ...
    addr_hit[16] = (reg_addr == CLKMGR_RECOV_ERR_CODE_OFFSET);
    addr_hit[17] = (reg_addr == CLKMGR_FATAL_ERR_CODE_OFFSET);
  end
  ...
  assign clk_enables_clk_exp_peri_en_wd = reg_wdata[2];

  assign clk_enables_clk_exp_div2_peri_en_wd = reg_wdata[3];

  assign clk_enables_clk_exp_div8_peri_en_wd = reg_wdata[4];

  assign clk_enables_clk_main_div2_peri_en_wd = reg_wdata[5];

  assign clk_enables_clk_main_div10_peri_en_wd = reg_wdata[6];

  assign clk_enables_clk_usb_div4_peri_en_wd = reg_wdata[7];

  assign clk_enables_clk_main_peri_en_wd = reg_wdata[8];

  assign clk_enables_clk_usb_peri_en_wd = reg_wdata[9];

  assign clk_enables_clk_exp2_peri_en_wd = reg_wdata[10];

  assign clk_enables_clk_exp2_div2_peri_en_wd = reg_wdata[11];

  assign clk_enables_clk_exp2_div6_peri_en_wd = reg_wdata[12];

  assign clk_enables_clk_io_peri_en_wd = reg_wdata[13];
  ...
  assign recov_err_code_we = addr_hit[16] & reg_we & !reg_error;
  ...
  assign recov_err_code_io_timeout_err_wd = reg_wdata[4];

  assign recov_err_code_io_div4_timeout_err_wd = reg_wdata[5];

  assign recov_err_code_main_timeout_err_wd = reg_wdata[6];
  ...
  always_comb begin
    ...
    reg_we_check[16] = recov_err_code_we;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[6]: begin
        ...
        reg_rdata_next[2] = clk_enables_clk_exp_peri_en_qs;
        reg_rdata_next[3] = clk_enables_clk_exp_div2_peri_en_qs;
        reg_rdata_next[4] = clk_enables_clk_exp_div8_peri_en_qs;
        reg_rdata_next[5] = clk_enables_clk_main_div2_peri_en_qs;
        reg_rdata_next[6] = clk_enables_clk_main_div10_peri_en_qs;
        reg_rdata_next[7] = clk_enables_clk_usb_div4_peri_en_qs;
        reg_rdata_next[8] = clk_enables_clk_main_peri_en_qs;
        reg_rdata_next[9] = clk_enables_clk_usb_peri_en_qs;
        reg_rdata_next[10] = clk_enables_clk_exp2_peri_en_qs;
        reg_rdata_next[11] = clk_enables_clk_exp2_div2_peri_en_qs;
        reg_rdata_next[12] = clk_enables_clk_exp2_div6_peri_en_qs;
        reg_rdata_next[13] = clk_enables_clk_io_peri_en_qs;
      end
      ...
      addr_hit[16]: begin
        ...
        reg_rdata_next[4] = recov_err_code_io_timeout_err_qs;
        reg_rdata_next[5] = recov_err_code_io_div4_timeout_err_qs;
        reg_rdata_next[6] = recov_err_code_main_timeout_err_qs;
      end
