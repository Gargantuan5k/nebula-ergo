...
package clkmgr_reg_pkg;
  ...
  parameter int NumSwGateableClocks = 14;
  ...
  typedef struct packed {
    ...
    struct packed {
      logic        q;
    } clk_exp2_div6_peri_en;
    struct packed {
      logic        q;
    } clk_exp2_div2_peri_en;
    struct packed {
      logic        q;
    } clk_exp2_peri_en;
    struct packed {
    ...
    struct packed {
      logic        q;
    } clk_usb_div4_peri_en;
    struct packed {
      logic        q;
    } clk_main_div10_peri_en;
    struct packed {
      logic        q;
    } clk_main_div2_peri_en;
    struct packed {
      logic        q;
    } clk_exp_div8_peri_en;
    struct packed {
      logic        q;
    } clk_exp_div2_peri_en;
    struct packed {
      logic        q;
    } clk_exp_peri_en;
    struct packed {
  ...
  // Register -> HW type
  typedef struct packed {
    clkmgr_reg2hw_alert_test_reg_t alert_test; // [102:99]
    clkmgr_reg2hw_extclk_ctrl_reg_t extclk_ctrl; // [98:91]
    clkmgr_reg2hw_jitter_enable_reg_t jitter_enable; // [90:87]
    clkmgr_reg2hw_clk_enables_reg_t clk_enables; // [86:73]
    clkmgr_reg2hw_clk_hints_reg_t clk_hints; // [72:72]
    clkmgr_reg2hw_measure_ctrl_regwen_reg_t measure_ctrl_regwen; // [71:71]
    clkmgr_reg2hw_io_meas_ctrl_en_reg_t io_meas_ctrl_en; // [70:67]
    clkmgr_reg2hw_io_meas_ctrl_shadowed_reg_t io_meas_ctrl_shadowed; // [66:47]
    clkmgr_reg2hw_io_div4_meas_ctrl_en_reg_t io_div4_meas_ctrl_en; // [46:43]
    clkmgr_reg2hw_io_div4_meas_ctrl_shadowed_reg_t io_div4_meas_ctrl_shadowed; // [42:27]
    clkmgr_reg2hw_main_meas_ctrl_en_reg_t main_meas_ctrl_en; // [26:23]
    clkmgr_reg2hw_main_meas_ctrl_shadowed_reg_t main_meas_ctrl_shadowed; // [22:3]
    clkmgr_reg2hw_fatal_err_code_reg_t fatal_err_code; // [2:0]
  } clkmgr_reg2hw_t;

  // HW -> register type
  typedef struct packed {
    clkmgr_hw2reg_extclk_status_reg_t extclk_status; // [42:39]
    clkmgr_hw2reg_clk_hints_status_reg_t clk_hints_status; // [38:37]
    clkmgr_hw2reg_measure_ctrl_regwen_reg_t measure_ctrl_regwen; // [36:35]
    clkmgr_hw2reg_io_meas_ctrl_en_reg_t io_meas_ctrl_en; // [34:30]
    clkmgr_hw2reg_io_div4_meas_ctrl_en_reg_t io_div4_meas_ctrl_en; // [29:25]
    clkmgr_hw2reg_main_meas_ctrl_en_reg_t main_meas_ctrl_en; // [24:20]
  ...
  parameter logic [BlockAw-1:0] CLKMGR_IO_DIV4_MEAS_CTRL_EN_OFFSET = 7'h 30;
  parameter logic [BlockAw-1:0] CLKMGR_IO_DIV4_MEAS_CTRL_SHADOWED_OFFSET = 7'h 34;
  parameter logic [BlockAw-1:0] CLKMGR_MAIN_MEAS_CTRL_EN_OFFSET = 7'h 38;
  parameter logic [BlockAw-1:0] CLKMGR_MAIN_MEAS_CTRL_SHADOWED_OFFSET = 7'h 3c;
  ...
  parameter logic [3:0] CLKMGR_PERMIT [18] = '{
    ...
    4'b 0011, // index[ 6] CLKMGR_CLK_ENABLES
    ...
    4'b 0001, // index[12] CLKMGR_IO_DIV4_MEAS_CTRL_EN
    4'b 0011, // index[13] CLKMGR_IO_DIV4_MEAS_CTRL_SHADOWED
    4'b 0001, // index[14] CLKMGR_MAIN_MEAS_CTRL_EN
    4'b 0111, // index[15] CLKMGR_MAIN_MEAS_CTRL_SHADOWED
