...
package clkmgr_pkg;
  ...
  typedef struct packed {
    ...
    logic clk_exp_powerup;
    logic clk_main_div2_powerup;
    logic clk_main_div10_powerup;
    logic clk_usb_div4_powerup;
    logic clk_exp_div2_powerup;
    logic clk_exp_div8_powerup;
    logic clk_exp2_powerup;
    logic clk_exp2_div2_powerup;
    logic clk_exp2_div6_powerup;
    logic clk_aon_peri;
    ...
    logic clk_exp_peri;
    logic clk_exp_div2_peri;
    logic clk_exp_div8_peri;
    logic clk_main_div2_peri;
    logic clk_main_div10_peri;
    logic clk_usb_div4_peri;
    logic clk_main_peri;
    logic clk_usb_peri;
    logic clk_exp2_peri;
    logic clk_exp2_div2_peri;
    logic clk_exp2_div6_peri;
    logic clk_io_peri;
  } clkmgr_out_t;
  ...
  typedef struct packed {
    ...
    prim_mubi_pkg::mubi4_t exp_powerup;
    prim_mubi_pkg::mubi4_t main_div2_powerup;
    prim_mubi_pkg::mubi4_t main_div10_powerup;
    prim_mubi_pkg::mubi4_t usb_div4_powerup;
    prim_mubi_pkg::mubi4_t exp_div2_powerup;
    prim_mubi_pkg::mubi4_t exp_div8_powerup;
    prim_mubi_pkg::mubi4_t exp2_powerup;
    prim_mubi_pkg::mubi4_t exp2_div2_powerup;
    prim_mubi_pkg::mubi4_t exp2_div6_powerup;
    ...
    prim_mubi_pkg::mubi4_t exp_peri;
    prim_mubi_pkg::mubi4_t exp_div2_peri;
    prim_mubi_pkg::mubi4_t exp_div8_peri;
    prim_mubi_pkg::mubi4_t main_div2_peri;
    prim_mubi_pkg::mubi4_t main_div10_peri;
    prim_mubi_pkg::mubi4_t usb_div4_peri;
    prim_mubi_pkg::mubi4_t main_peri;
    prim_mubi_pkg::mubi4_t usb_peri;
    prim_mubi_pkg::mubi4_t exp2_peri;
    prim_mubi_pkg::mubi4_t exp2_div2_peri;
    prim_mubi_pkg::mubi4_t exp2_div6_peri;
    prim_mubi_pkg::mubi4_t io_peri;
  } clkmgr_cg_en_t;

  parameter int NumOutputClk = 38;
