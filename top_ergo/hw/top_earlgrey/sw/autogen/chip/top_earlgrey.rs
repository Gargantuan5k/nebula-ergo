...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_BRIDGE0_BASE_ADDR: usize = 0x40060000;

/// Peripheral size for ergo_cdc_bridge0 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_BRIDGE0_BASE_ADDR and
/// `ERGO_CDC_BRIDGE0_BASE_ADDR + ERGO_CDC_BRIDGE0_SIZE_BYTES`.
pub const ERGO_CDC_BRIDGE0_SIZE_BYTES: usize = 0x10;

/// Peripheral base address for ergo_cdc_bridge1 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_BRIDGE1_BASE_ADDR: usize = 0x40070000;

/// Peripheral size for ergo_cdc_bridge1 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_BRIDGE1_BASE_ADDR and
/// `ERGO_CDC_BRIDGE1_BASE_ADDR + ERGO_CDC_BRIDGE1_SIZE_BYTES`.
pub const ERGO_CDC_BRIDGE1_SIZE_BYTES: usize = 0x10;

/// Peripheral base address for ergo_cdc_bridge2 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_BRIDGE2_BASE_ADDR: usize = 0x400B0000;

/// Peripheral size for ergo_cdc_bridge2 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_BRIDGE2_BASE_ADDR and
/// `ERGO_CDC_BRIDGE2_BASE_ADDR + ERGO_CDC_BRIDGE2_SIZE_BYTES`.
pub const ERGO_CDC_BRIDGE2_SIZE_BYTES: usize = 0x10;

/// Peripheral base address for ergo_cdc_bridge3 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_BRIDGE3_BASE_ADDR: usize = 0x400C0000;

/// Peripheral size for ergo_cdc_bridge3 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_BRIDGE3_BASE_ADDR and
/// `ERGO_CDC_BRIDGE3_BASE_ADDR + ERGO_CDC_BRIDGE3_SIZE_BYTES`.
pub const ERGO_CDC_BRIDGE3_SIZE_BYTES: usize = 0x10;

/// Peripheral base address for ergo_cdc_bridge4 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_BRIDGE4_BASE_ADDR: usize = 0x400D0000;

/// Peripheral size for ergo_cdc_bridge4 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_BRIDGE4_BASE_ADDR and
/// `ERGO_CDC_BRIDGE4_BASE_ADDR + ERGO_CDC_BRIDGE4_SIZE_BYTES`.
pub const ERGO_CDC_BRIDGE4_SIZE_BYTES: usize = 0x10;

/// Peripheral base address for ergo_cdc_bridge5 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_BRIDGE5_BASE_ADDR: usize = 0x40110000;

/// Peripheral size for ergo_cdc_bridge5 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_BRIDGE5_BASE_ADDR and
/// `ERGO_CDC_BRIDGE5_BASE_ADDR + ERGO_CDC_BRIDGE5_SIZE_BYTES`.
pub const ERGO_CDC_BRIDGE5_SIZE_BYTES: usize = 0x10;

/// Peripheral base address for ergo_setup_gen0 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_SETUP_GEN0_BASE_ADDR: usize = 0x40120000;

/// Peripheral size for ergo_setup_gen0 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_SETUP_GEN0_BASE_ADDR and
/// `ERGO_SETUP_GEN0_BASE_ADDR + ERGO_SETUP_GEN0_SIZE_BYTES`.
pub const ERGO_SETUP_GEN0_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_setup_gen1 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_SETUP_GEN1_BASE_ADDR: usize = 0x40160000;

/// Peripheral size for ergo_setup_gen1 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_SETUP_GEN1_BASE_ADDR and
/// `ERGO_SETUP_GEN1_BASE_ADDR + ERGO_SETUP_GEN1_SIZE_BYTES`.
pub const ERGO_SETUP_GEN1_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_setup_gen2 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_SETUP_GEN2_BASE_ADDR: usize = 0x40170000;

/// Peripheral size for ergo_setup_gen2 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_SETUP_GEN2_BASE_ADDR and
/// `ERGO_SETUP_GEN2_BASE_ADDR + ERGO_SETUP_GEN2_SIZE_BYTES`.
pub const ERGO_SETUP_GEN2_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_setup_gen3 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_SETUP_GEN3_BASE_ADDR: usize = 0x40180000;

/// Peripheral size for ergo_setup_gen3 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_SETUP_GEN3_BASE_ADDR and
/// `ERGO_SETUP_GEN3_BASE_ADDR + ERGO_SETUP_GEN3_SIZE_BYTES`.
pub const ERGO_SETUP_GEN3_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_setup_gen4 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_SETUP_GEN4_BASE_ADDR: usize = 0x40190000;

/// Peripheral size for ergo_setup_gen4 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_SETUP_GEN4_BASE_ADDR and
/// `ERGO_SETUP_GEN4_BASE_ADDR + ERGO_SETUP_GEN4_SIZE_BYTES`.
pub const ERGO_SETUP_GEN4_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_setup_gen5 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_SETUP_GEN5_BASE_ADDR: usize = 0x401A0000;

/// Peripheral size for ergo_setup_gen5 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_SETUP_GEN5_BASE_ADDR and
/// `ERGO_SETUP_GEN5_BASE_ADDR + ERGO_SETUP_GEN5_SIZE_BYTES`.
pub const ERGO_SETUP_GEN5_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_hold_gen0 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_HOLD_GEN0_BASE_ADDR: usize = 0x401B0000;

/// Peripheral size for ergo_hold_gen0 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_HOLD_GEN0_BASE_ADDR and
/// `ERGO_HOLD_GEN0_BASE_ADDR + ERGO_HOLD_GEN0_SIZE_BYTES`.
pub const ERGO_HOLD_GEN0_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_hold_gen1 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_HOLD_GEN1_BASE_ADDR: usize = 0x401C0000;

/// Peripheral size for ergo_hold_gen1 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_HOLD_GEN1_BASE_ADDR and
/// `ERGO_HOLD_GEN1_BASE_ADDR + ERGO_HOLD_GEN1_SIZE_BYTES`.
pub const ERGO_HOLD_GEN1_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_hold_gen2 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_HOLD_GEN2_BASE_ADDR: usize = 0x401D0000;

/// Peripheral size for ergo_hold_gen2 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_HOLD_GEN2_BASE_ADDR and
/// `ERGO_HOLD_GEN2_BASE_ADDR + ERGO_HOLD_GEN2_SIZE_BYTES`.
pub const ERGO_HOLD_GEN2_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_hold_gen3 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_HOLD_GEN3_BASE_ADDR: usize = 0x401E0000;

/// Peripheral size for ergo_hold_gen3 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_HOLD_GEN3_BASE_ADDR and
/// `ERGO_HOLD_GEN3_BASE_ADDR + ERGO_HOLD_GEN3_SIZE_BYTES`.
pub const ERGO_HOLD_GEN3_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_hold_gen4 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_HOLD_GEN4_BASE_ADDR: usize = 0x401F0000;

/// Peripheral size for ergo_hold_gen4 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_HOLD_GEN4_BASE_ADDR and
/// `ERGO_HOLD_GEN4_BASE_ADDR + ERGO_HOLD_GEN4_SIZE_BYTES`.
pub const ERGO_HOLD_GEN4_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_cdc_hazard_gen0 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_HAZARD_GEN0_BASE_ADDR: usize = 0x40200000;

/// Peripheral size for ergo_cdc_hazard_gen0 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_HAZARD_GEN0_BASE_ADDR and
/// `ERGO_CDC_HAZARD_GEN0_BASE_ADDR + ERGO_CDC_HAZARD_GEN0_SIZE_BYTES`.
pub const ERGO_CDC_HAZARD_GEN0_SIZE_BYTES: usize = 0x4;

/// Peripheral base address for ergo_cdc_hazard_gen1 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_HAZARD_GEN1_BASE_ADDR: usize = 0x40210000;

/// Peripheral size for ergo_cdc_hazard_gen1 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_HAZARD_GEN1_BASE_ADDR and
/// `ERGO_CDC_HAZARD_GEN1_BASE_ADDR + ERGO_CDC_HAZARD_GEN1_SIZE_BYTES`.
pub const ERGO_CDC_HAZARD_GEN1_SIZE_BYTES: usize = 0x4;

/// Peripheral base address for ergo_cdc_hazard_gen2 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_HAZARD_GEN2_BASE_ADDR: usize = 0x40220000;

/// Peripheral size for ergo_cdc_hazard_gen2 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_HAZARD_GEN2_BASE_ADDR and
/// `ERGO_CDC_HAZARD_GEN2_BASE_ADDR + ERGO_CDC_HAZARD_GEN2_SIZE_BYTES`.
pub const ERGO_CDC_HAZARD_GEN2_SIZE_BYTES: usize = 0x4;

/// Peripheral base address for ergo_cdc_hazard_gen3 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_HAZARD_GEN3_BASE_ADDR: usize = 0x40230000;

/// Peripheral size for ergo_cdc_hazard_gen3 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_HAZARD_GEN3_BASE_ADDR and
/// `ERGO_CDC_HAZARD_GEN3_BASE_ADDR + ERGO_CDC_HAZARD_GEN3_SIZE_BYTES`.
pub const ERGO_CDC_HAZARD_GEN3_SIZE_BYTES: usize = 0x4;

/// Peripheral base address for ergo_cdc_hazard_gen4 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_HAZARD_GEN4_BASE_ADDR: usize = 0x40240000;

/// Peripheral size for ergo_cdc_hazard_gen4 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_HAZARD_GEN4_BASE_ADDR and
/// `ERGO_CDC_HAZARD_GEN4_BASE_ADDR + ERGO_CDC_HAZARD_GEN4_SIZE_BYTES`.
pub const ERGO_CDC_HAZARD_GEN4_SIZE_BYTES: usize = 0x4;

/// Peripheral base address for ergo_cdc_bridge6 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_BRIDGE6_BASE_ADDR: usize = 0x40250000;

/// Peripheral size for ergo_cdc_bridge6 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_BRIDGE6_BASE_ADDR and
/// `ERGO_CDC_BRIDGE6_BASE_ADDR + ERGO_CDC_BRIDGE6_SIZE_BYTES`.
pub const ERGO_CDC_BRIDGE6_SIZE_BYTES: usize = 0x10;

/// Peripheral base address for ergo_cdc_bridge7 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_BRIDGE7_BASE_ADDR: usize = 0x40260000;

/// Peripheral size for ergo_cdc_bridge7 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_BRIDGE7_BASE_ADDR and
/// `ERGO_CDC_BRIDGE7_BASE_ADDR + ERGO_CDC_BRIDGE7_SIZE_BYTES`.
pub const ERGO_CDC_BRIDGE7_SIZE_BYTES: usize = 0x10;

/// Peripheral base address for ergo_cdc_bridge8 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_BRIDGE8_BASE_ADDR: usize = 0x40270000;

/// Peripheral size for ergo_cdc_bridge8 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_BRIDGE8_BASE_ADDR and
/// `ERGO_CDC_BRIDGE8_BASE_ADDR + ERGO_CDC_BRIDGE8_SIZE_BYTES`.
pub const ERGO_CDC_BRIDGE8_SIZE_BYTES: usize = 0x10;

/// Peripheral base address for ergo_setup_gen6 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_SETUP_GEN6_BASE_ADDR: usize = 0x40280000;

/// Peripheral size for ergo_setup_gen6 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_SETUP_GEN6_BASE_ADDR and
/// `ERGO_SETUP_GEN6_BASE_ADDR + ERGO_SETUP_GEN6_SIZE_BYTES`.
pub const ERGO_SETUP_GEN6_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_setup_gen7 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_SETUP_GEN7_BASE_ADDR: usize = 0x40290000;

/// Peripheral size for ergo_setup_gen7 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_SETUP_GEN7_BASE_ADDR and
/// `ERGO_SETUP_GEN7_BASE_ADDR + ERGO_SETUP_GEN7_SIZE_BYTES`.
pub const ERGO_SETUP_GEN7_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_setup_gen8 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_SETUP_GEN8_BASE_ADDR: usize = 0x402A0000;

/// Peripheral size for ergo_setup_gen8 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_SETUP_GEN8_BASE_ADDR and
/// `ERGO_SETUP_GEN8_BASE_ADDR + ERGO_SETUP_GEN8_SIZE_BYTES`.
pub const ERGO_SETUP_GEN8_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_hold_gen5 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_HOLD_GEN5_BASE_ADDR: usize = 0x402B0000;

/// Peripheral size for ergo_hold_gen5 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_HOLD_GEN5_BASE_ADDR and
/// `ERGO_HOLD_GEN5_BASE_ADDR + ERGO_HOLD_GEN5_SIZE_BYTES`.
pub const ERGO_HOLD_GEN5_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_hold_gen6 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_HOLD_GEN6_BASE_ADDR: usize = 0x402C0000;

/// Peripheral size for ergo_hold_gen6 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_HOLD_GEN6_BASE_ADDR and
/// `ERGO_HOLD_GEN6_BASE_ADDR + ERGO_HOLD_GEN6_SIZE_BYTES`.
pub const ERGO_HOLD_GEN6_SIZE_BYTES: usize = 0x8;

/// Peripheral base address for ergo_cdc_hazard_gen5 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_HAZARD_GEN5_BASE_ADDR: usize = 0x402D0000;

/// Peripheral size for ergo_cdc_hazard_gen5 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_HAZARD_GEN5_BASE_ADDR and
/// `ERGO_CDC_HAZARD_GEN5_BASE_ADDR + ERGO_CDC_HAZARD_GEN5_SIZE_BYTES`.
pub const ERGO_CDC_HAZARD_GEN5_SIZE_BYTES: usize = 0x4;

/// Peripheral base address for ergo_cdc_hazard_gen6 in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ERGO_CDC_HAZARD_GEN6_BASE_ADDR: usize = 0x402E0000;

/// Peripheral size for ergo_cdc_hazard_gen6 in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #ERGO_CDC_HAZARD_GEN6_BASE_ADDR and
/// `ERGO_CDC_HAZARD_GEN6_BASE_ADDR + ERGO_CDC_HAZARD_GEN6_SIZE_BYTES`.
pub const ERGO_CDC_HAZARD_GEN6_SIZE_BYTES: usize = 0x4;
...
impl TryFrom<u32> for PlicPeripheral {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            12 => Ok(Self::FlashCtrl),
            13 => Ok(Self::Keymgr),
            14 => Ok(Self::Csrng),
            15 => Ok(Self::EntropySrc),
            16 => Ok(Self::Edn0),
            _ => Err(val),
        }
    }
...
impl TryFrom<u32> for PlicIrqId {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            66 => Ok(Self::KmacKmacDone),
            67 => Ok(Self::KmacFifoEmpty),
            68 => Ok(Self::KmacKmacErr),
            ...
            80 => Ok(Self::FlashCtrlProgEmpty),
            81 => Ok(Self::FlashCtrlProgLvl),
            82 => Ok(Self::FlashCtrlRdFull),
            83 => Ok(Self::FlashCtrlRdLvl),
            84 => Ok(Self::FlashCtrlOpDone),
            85 => Ok(Self::FlashCtrlCorrErr),
            86 => Ok(Self::KeymgrOpDone),
            87 => Ok(Self::CsrngCsCmdReqDone),
            88 => Ok(Self::CsrngCsEntropyReq),
            89 => Ok(Self::CsrngCsHwInstExc),
            90 => Ok(Self::CsrngCsFatalErr),
            91 => Ok(Self::EntropySrcEsEntropyValid),
            92 => Ok(Self::EntropySrcEsHealthTestFailed),
            93 => Ok(Self::EntropySrcEsObserveFifoReady),
            94 => Ok(Self::EntropySrcEsFatalErr),
            95 => Ok(Self::Edn0EdnCmdReqDone),
            96 => Ok(Self::Edn0EdnFatalErr),
            _ => Err(val),
        }
    }
}
...
pub enum AlertId {
    ...
    PinmuxAonFatalFault = 21,
    /// aon_timer_aon_fatal_fault
    AonTimerAonFatalFault = 22,
    /// sram_ctrl_ret_aon_fatal_error
    SramCtrlRetAonFatalError = 23,
    /// flash_ctrl_recov_err
    FlashCtrlRecovErr = 24,
    /// flash_ctrl_fatal_std_err
    FlashCtrlFatalStdErr = 25,
    /// flash_ctrl_fatal_err
    FlashCtrlFatalErr = 26,
    /// flash_ctrl_fatal_prim_flash_alert
    FlashCtrlFatalPrimFlashAlert = 27,
    /// flash_ctrl_recov_prim_flash_alert
    FlashCtrlRecovPrimFlashAlert = 28,
    /// rv_dm_fatal_fault
    RvDmFatalFault = 29,
    /// rv_plic_fatal_fault
    RvPlicFatalFault = 30,
...
impl TryFrom<u32> for AlertId {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            5 => Ok(Self::KmacRecovOperationErr),
            6 => Ok(Self::KmacFatalFaultErr),
            ...
            21 => Ok(Self::PinmuxAonFatalFault),
            22 => Ok(Self::AonTimerAonFatalFault),
            23 => Ok(Self::SramCtrlRetAonFatalError),
            24 => Ok(Self::FlashCtrlRecovErr),
            25 => Ok(Self::FlashCtrlFatalStdErr),
            26 => Ok(Self::FlashCtrlFatalErr),
            27 => Ok(Self::FlashCtrlFatalPrimFlashAlert),
            28 => Ok(Self::FlashCtrlRecovPrimFlashAlert),
            29 => Ok(Self::RvDmFatalFault),
            30 => Ok(Self::RvPlicFatalFault),
...
/// `AlertPeripheral`.
pub const ALERT_FOR_PERIPHERAL: [AlertPeripheral; 45] = [
...
pub const NUM_DIO_PADS: usize = 12;
...
pub enum GateableClocks {
    ...
    IoDiv2Peri = 1,
    /// Clock clk_exp_peri in group peri
    ExpPeri = 2,
    /// Clock clk_exp_div2_peri in group peri
    ExpDiv2Peri = 3,
    /// Clock clk_exp_div8_peri in group peri
    ExpDiv8Peri = 4,
    /// Clock clk_main_div2_peri in group peri
    MainDiv2Peri = 5,
    /// Clock clk_main_div10_peri in group peri
    MainDiv10Peri = 6,
    /// Clock clk_usb_div4_peri in group peri
    UsbDiv4Peri = 7,
    /// Clock clk_main_peri in group peri
    MainPeri = 8,
    /// Clock clk_usb_peri in group peri
    UsbPeri = 9,
    /// Clock clk_exp2_peri in group peri
    Exp2Peri = 10,
    /// Clock clk_exp2_div2_peri in group peri
    Exp2Div2Peri = 11,
    /// Clock clk_exp2_div6_peri in group peri
    Exp2Div6Peri = 12,
