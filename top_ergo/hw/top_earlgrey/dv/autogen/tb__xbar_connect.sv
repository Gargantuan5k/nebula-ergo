...
tl_if ergo_cdc_bridge0_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_bridge1_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_bridge2_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_bridge3_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_bridge4_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_bridge5_tl_if(clk_io_div4, rst_n);
tl_if ergo_setup_gen0_tl_if(clk_io_div4, rst_n);
tl_if ergo_setup_gen1_tl_if(clk_io_div4, rst_n);
tl_if ergo_setup_gen2_tl_if(clk_io_div4, rst_n);
tl_if ergo_setup_gen3_tl_if(clk_io_div4, rst_n);
tl_if ergo_setup_gen4_tl_if(clk_io_div4, rst_n);
tl_if ergo_setup_gen5_tl_if(clk_io_div4, rst_n);
tl_if ergo_hold_gen0_tl_if(clk_io_div4, rst_n);
tl_if ergo_hold_gen1_tl_if(clk_io_div4, rst_n);
tl_if ergo_hold_gen2_tl_if(clk_io_div4, rst_n);
tl_if ergo_hold_gen3_tl_if(clk_io_div4, rst_n);
tl_if ergo_hold_gen4_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_hazard_gen0_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_hazard_gen1_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_hazard_gen2_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_hazard_gen3_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_hazard_gen4_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_bridge6_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_bridge7_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_bridge8_tl_if(clk_io_div4, rst_n);
tl_if ergo_setup_gen6_tl_if(clk_io_div4, rst_n);
tl_if ergo_setup_gen7_tl_if(clk_io_div4, rst_n);
tl_if ergo_setup_gen8_tl_if(clk_io_div4, rst_n);
tl_if ergo_hold_gen5_tl_if(clk_io_div4, rst_n);
tl_if ergo_hold_gen6_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_hazard_gen5_tl_if(clk_io_div4, rst_n);
tl_if ergo_cdc_hazard_gen6_tl_if(clk_io_div4, rst_n);
...
`ifndef GATE_LEVEL
    ...
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_bridge0, ergo_cdc_bridge0, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_bridge1, ergo_cdc_bridge1, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_bridge2, ergo_cdc_bridge2, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_bridge3, ergo_cdc_bridge3, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_bridge4, ergo_cdc_bridge4, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_bridge5, ergo_cdc_bridge5, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_setup_gen0, ergo_setup_gen0, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_setup_gen1, ergo_setup_gen1, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_setup_gen2, ergo_setup_gen2, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_setup_gen3, ergo_setup_gen3, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_setup_gen4, ergo_setup_gen4, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_setup_gen5, ergo_setup_gen5, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_hold_gen0, ergo_hold_gen0, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_hold_gen1, ergo_hold_gen1, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_hold_gen2, ergo_hold_gen2, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_hold_gen3, ergo_hold_gen3, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_hold_gen4, ergo_hold_gen4, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_hazard_gen0, ergo_cdc_hazard_gen0, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_hazard_gen1, ergo_cdc_hazard_gen1, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_hazard_gen2, ergo_cdc_hazard_gen2, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_hazard_gen3, ergo_cdc_hazard_gen3, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_hazard_gen4, ergo_cdc_hazard_gen4, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_bridge6, ergo_cdc_bridge6, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_bridge7, ergo_cdc_bridge7, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_bridge8, ergo_cdc_bridge8, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_setup_gen6, ergo_setup_gen6, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_setup_gen7, ergo_setup_gen7, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_setup_gen8, ergo_setup_gen8, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_hold_gen5, ergo_hold_gen5, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_hold_gen6, ergo_hold_gen6, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_hazard_gen5, ergo_cdc_hazard_gen5, tl)
    `DRIVE_CHIP_TL_DEVICE_IF(ergo_cdc_hazard_gen6, ergo_cdc_hazard_gen6, tl)
